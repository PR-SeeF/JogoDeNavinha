...
from code.Const import COLOR_YELLOW, SCORE_POSITION, MENU_OPTION, COLOR_WHITE, COLOR_BLACK, COLOR_ORANGE
...
class Score:
    ...
    def save_score(self, menu_return: str, player_score: list[int]):
        ...
        while True:
            ...
            self.score_text(text_size=50, text='YOU WINN !!!!!', text_color=COLOR_ORANGE,
    ...
    def show_score(self):
        ...
        pygame.mixer.music.play(-1)
        self.window.blit(source=self.surf, dest=self.rect)
        self.score_text(48, 'TOP 10 SCORE', COLOR_ORANGE, SCORE_POSITION['Title'])
        self.score_text(20, 'NAME     SCORE           DATE      ', COLOR_ORANGE, SCORE_POSITION['Label'])
        db_proxy = DBProxy('DBScore')
