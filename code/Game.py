    ...
    def run(self):
        ...
        while True:
            ...
            if menu_return in [MENU_OPTION[0], MENU_OPTION[1]]:
                ...
                enemy_clock = 5000
                position_player = ENTITY_POSITION['Player2'][0] + WINDOW_WIDTH - 20, ENTITY_POSITION['Player2'][1]
                level = Level(self.window, 'Level1', menu_return, player_score, player_health)
                level_return = level.run(player_score, player_health, enemy_clock, position_player)
